...
export const TEAM_BRANDING: Record<string, TeamBranding> = {
  ...
  "Ahmedabad Giants": {
    ...
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(11,19,43,0.95)_0%,rgba(8,15,35,0.85)_45%,rgba(5,10,25,0.9)_100%)]",
  },
  "Punjab Kings": {
  ...
  "Indore Titans": {
    ...
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(0,116,217,0.95)_0%,rgba(0,90,170,0.85)_45%,rgba(0,70,130,0.9)_100%)]",
  },
  "Goa Gladiators": {
    logo: "/images/teams/gg.png",
    borderColor: "border-[#00BCD4]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(0,188,212,0.95)_0%,rgba(0,150,170,0.85)_45%,rgba(0,120,140,0.9)_100%)]",
  },
  "Gujarat Titans": {
  ...
  "Gujarat Blasters": {
    ...
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(255,107,53,0.95)_0%,rgba(200,85,40,0.85)_45%,rgba(160,68,32,0.9)_100%)]",
  },
  "Pune Panthers": {
    logo: "/images/teams/pp.png",
    borderColor: "border-[#5E35B1]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(94,53,177,0.95)_0%,rgba(75,40,140,0.85)_45%,rgba(60,30,110,0.9)_100%)]",
  },
  "Kanpur Knights": {
    logo: "/images/teams/kp.png",
    borderColor: "border-[#424242]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(66,66,66,0.95)_0%,rgba(50,50,50,0.85)_45%,rgba(35,35,35,0.9)_100%)]",
  },
};
...
export const RESERVED_TEAM_COLORS = [
  {
    ...
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(0,200,83,0.95)_0%,rgba(0,160,65,0.85)_45%,rgba(0,120,50,0.9)_100%)]", // Emerald Green - Unique!
  },
  {
    borderColor: "border-[#880E4F]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(136,14,79,0.95)_0%,rgba(110,10,65,0.85)_45%,rgba(85,8,50,0.9)_100%)]", // Wine/Maroon - Unique!
  },
  {
    borderColor: "border-[#795548]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(121,85,72,0.95)_0%,rgba(95,65,55,0.85)_45%,rgba(70,50,40,0.9)_100%)]", // Brown - Unique!
  },
  {
    borderColor: "border-[#009688]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(0,150,136,0.95)_0%,rgba(0,120,110,0.85)_45%,rgba(0,90,85,0.9)_100%)]", // Teal - Unique!
  },
  {
    borderColor: "border-[#E91E63]",
    bgGradient:
      "bg-[linear-gradient(135deg,rgba(233,30,99,0.95)_0%,rgba(190,25,80,0.85)_45%,rgba(150,20,65,0.9)_100%)]", // Magenta - Unique!
  },
];
...
export const DEFAULT_TEAM_BRANDING: TeamBranding = {
  ...
  bgGradient:
    "bg-[linear-gradient(135deg,rgba(100,100,100,0.95)_0%,rgba(60,60,60,0.85)_45%,rgba(40,40,40,0.9)_100%)]",
};
...
export function getTeamBranding(teamName: string): TeamBranding {
  ...
  if (!teamColorAssignments.has(teamName)) {
    ...
    teamColorAssignments.set(
      teamName,
      nextColorIndex % RESERVED_TEAM_COLORS.length
    );
    nextColorIndex++;
  }
